...
const highlights = [
  { icon: Shield, text: 'Desde 2011' },
  { icon: CheckCircle, text: 'Atendimento Premium' },
  { icon: Clock, text: 'Suporte Emergencial' },
];
    ...
    >
      ...
      <div className="container-width section-padding relative z-10 pt-32">
        <div className="max-w-4xl">
          ...
          {/* Subheading */}
          <p className="text-lg sm:text-xl text-white/80 max-w-2xl mb-8 animate-slide-up" style={{ animationDelay: '0.1s' }}>
